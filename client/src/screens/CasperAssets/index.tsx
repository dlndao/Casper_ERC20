...
import { logoDark, CasperLabs, Casper2 } from 'Assets/img';
...
function CasperAssets() {
  ...
  const handleMint = async () => {
    ...
    console.log(`https://testnet.cspr.live/deploy/${transferFromUserWallet}`);
  ...
  const handleUnStake = async (e) => {
    ...
    console.log(`https://testnet.cspr.live/deploy/${transferToUserWallet}`);
