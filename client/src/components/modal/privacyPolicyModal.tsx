    ...
    >
      <div className='dln-privacy'>
        ...
        <p>
          ...
          collected from the users of the website DLN.org and other websites
          which use subdomains of DLN.org (“the Site”). We are committed to
          protecting and respecting your privacy. Please read this carefully as
        ...
        <p>
          ...
          Decentralized Autonomous Organization. You can reach us with any
          request relating to this Privacy Policy via contact details provided
          below.
        </p>
        ...
        <p>
          ...
          typically stored on your computer&#39;s hard drive. Information
          collected from cookies is used by us to evaluate the effectiveness of
          our Site and analyze trends. The information collected from cookies
          allows us to determine such things as which parts of the Site are most
          visited and difficulties our visitors may experience in accessing the
          Site. With this knowledge, we can improve the quality of your
          experience on the Site by recognizing and delivering more of the most
        ...
        <p>
          ...
          cookies on the hard drive of your computer (or use similar
          technologies) and will receive information that we select that will
          educate us on such things as how visitors navigate around our Site.
          This information is aggregated to provide statistical data about our
        ...
        <p>
          ...
          service providers will be used to assist us in better understanding
          our visitors&#39; interests in our Site and how to better serve those
          ...
          the Site with a browser that is configure to accept cookies
        ...
        <p>
          ...
          DLN. We shall only do this where you have given us your consent. If
          you want to opt out of receiving promotional and marketing emails in
          relation to which you might receive in accordance with this section,
          you can best opt out by clicking &quot;unsubscribe&quot; at the bottom
          of an email we sent you.
        </p>
        ...
        <p>
          ...
          us, which you may give voluntarily, only in order to answer your
          contact question or to reply to your email in the best possible
          manner.
        </p>
        <h4>Social media</h4>
        <p>
          We may use plugins from social networks such as GitHub, YouTube,
          Reddit, Twitter, Telegram, Medium on the Site. When you activate them
          (by clicking on them), the operators of the respective social networks
          may record that you are on the Site and may use this information. This
          ...
          platforms regarding their privacy policies. We are not responsible for
          data collected by these individual social media platforms.
        </p>
        <h4>Your Rights</h4>
        <h5>Right to access</h5>
        <p>
          As a data subject you have the right to obtain from us free
          information about your personal data processed at any time and a copy
          of this information. Furthermore, you will have access to the
          following information: the purposes of the processing; the categories
          of personal data concerned; where possible, the envisaged period for
          which the personal data will be processed, or, if not possible, the
          criteria used to determine that period; the existence of the right to
          request from us rectification or erasure of personal data, or
          restriction of processing of personal data concerning you, or to
          ...
          not collected directly from you, any available information as to their
          source; and the existence of automated decision-making, including
          profiling, and, at least in those cases, meaningful information about
        ...
        <p>
          ...
          account the purposes of the processing, you shall have the right to
        ...
        <p>
          ...
          to erase personal data without undue delay where required by the law,
          including when:
        </p>
        <ul>
          <li>
        ...
        <p>
          ...
          ourselves. We choose the processors carefully to ensure compliance
        ...
        <p>
          ...
          given on the Site. We assume no responsibility and liability for
          these.
        </p>
